...
const EditProfileForm = ({ user }) => {
  ...
  useEffect(() => {
    const usersAddresses = usersAddress.filter((a) => a.userId === user.id);
    const currentAddressUser = usersAddress.find(
      (a) => a.id === user.currentAddress
    );

    const transformAddresses = usersAddresses.map((a) => ({
      value: a.id,
  ...
  // function transformUserAddressesOptions(usersAddresses) {
  //   const options = usersAddresses.map((a) => ({
  //     value: a.id,
  //     label: renderUserAddress(a),
  //   }));
  //   return options;
